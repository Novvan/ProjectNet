...
namespace ProjectNet.Utils
{
	public static class Tools
	{
		...
		/// <summary>
		/// Negates the current float.
		/// </summary>
		public static double Negate(this double val) => val * -1;

		public static float Negate(this float val) => val * -1;
